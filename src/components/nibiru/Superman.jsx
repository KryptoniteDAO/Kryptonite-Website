...
return (
<div class="bg-green-50 relative isolate overflow-hidden h-screen -mb-28">
  <main>
...
<div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 sm:px-8 lg:pb-48 lg:pt-60">
			...
			Nibiru's Premier <br/>DeFi Platform
                    </h1>

                    <p class="mt-6 text-lg text-gray-600 sm:max-w-md lg:max-w-none">
			Redefining the MEV user experience by unlocking your full earning<br/>potential through liquid staking.
                    </p>

                    <div class="mt-10 flex items-center gap-x-6">
                      <a
                        href="https://app.kryptonite.finance/nibiru"
                        target="_blank"
